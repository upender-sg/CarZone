...
#DATABASES = {'default': dj_database_url.config(default='postgres://postgres:qWerty@123@localhost/carzone_db')}
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'upendershanagonda79@gmail.com'
EMAIL_HOST_PASSWORD = 'havish143'
EMAIL_USE_TLS = True
